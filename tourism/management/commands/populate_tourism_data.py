    ...
    def create_destinations(self):
        ...
        destinations_data = [
            ...
            },
            {
                ...
                'city': 'New Delhi',
                'categories': ['historical', 'cultural'],
                'description': 'The Red Fort is a historic fortified palace of the Mughal emperors for nearly 200 years, until 1856. It is located in the center of Delhi and houses museums that contain relics of the Mughal period.',
                'short_description': 'Historic Mughal fortress and UNESCO World Heritage Site',
                'latitude': Decimal('28.6562'),
                'longitude': Decimal('77.2410'),
                'best_time_to_visit': 'October to March',
                'entry_fee': '₹35 for Indians, ₹500 for foreigners',
                'opening_hours': '9:30 AM to 4:30 PM (Closed on Mondays)',
                'historical_significance': 'Built by Emperor Shah Jahan, served as the residence of Mughal emperors.',
                'cultural_importance': 'Symbol of India\'s independence, Prime Minister addresses the nation from here on Independence Day.',
                'local_cuisine': 'Paranthe Wali Gali food, Mughlai cuisine, Street food',
                'featured': True,
            ...
            },
            {
                ...
                'description': 'Varanasi is one of the oldest inhabited cities in the world and India\'s spiritual capital. The sacred ghats along the Ganges River are where pilgrims come to bathe in holy waters and perform religious rituals.',
                'short_description': 'Sacred city with ancient ghats along the holy Ganges River',
                'latitude': Decimal('25.2820'),
                'longitude': Decimal('82.9739'),
                'best_time_to_visit': 'October to March',
                'entry_fee': 'Free',
                'opening_hours': '24 hours',
                'historical_significance': 'One of the oldest continuously inhabited cities in the world, over 3000 years old.',
                'cultural_importance': 'Holiest city in Hinduism, center of learning and spirituality.',
                'local_cuisine': 'Kachori Sabzi, Baati Chokha, Lassi, Malaiyo',
                'featured': True,
                'average_rating': Decimal('4.5'),
                'total_reviews': 9876,
            },
            {
                ...
                'description': 'Ranthambore National Park is famous for its tiger population and is one of the best places in India to spot the majestic Bengal tigers in their natural habitat.',
                'short_description': 'Famous tiger reserve with historic Ranthambore Fort',
                'latitude': Decimal('26.0173'),
                'longitude': Decimal('76.5026'),
                'best_time_to_visit': 'October to June',
                'entry_fee': '₹25-200 for Indians, ₹200-1300 for foreigners (varies by zone and vehicle)',
                'opening_hours': '6:30 AM to 10:00 AM, 2:30 PM to 6:00 PM',
                'historical_significance': 'Contains the historic Ranthambore Fort, a UNESCO World Heritage Site.',
                'cultural_importance': 'Important for wildlife conservation, Project Tiger reserve.',
                'local_cuisine': 'Rajasthani Thali, Game meat (where permitted), Dal Baati Churma',
                'featured': False,
                'average_rating': Decimal('4.6'),
                'total_reviews': 5432,
            },
            {
                ...
                'description': 'Munnar is a hill station and former resort for the British Raj elite. It\'s surrounded by rolling hills dotted with tea plantations established in the late 19th century.',
                'short_description': 'Scenic hill station famous for sprawling tea plantations',
                'latitude': Decimal('10.1632'),
                'longitude': Decimal('77.0729'),
                'best_time_to_visit': 'September to March',
                'entry_fee': 'Tea plantation visits: ₹10-50',
                'opening_hours': 'Tea gardens: 8:00 AM to 5:00 PM',
                'historical_significance': 'British colonial hill station, tea cultivation since 1870s.',
                'cultural_importance': 'Center of tea production in Kerala, ecological importance.',
                'local_cuisine': 'Kerala Sadya, Puttu, Appam, Fresh tea',
                'featured': False,
                'average_rating': Decimal('4.7'),
                'total_reviews': 6789,
            },
            {
                ...
                'state': 'Maharashtra',
                'city': 'Aurangabad',
                'categories': ['historical', 'cultural', 'religious'],
                'description': 'The Ajanta and Ellora caves are ancient rock-cut cave monuments that showcase exceptional artistry and religious devotion, representing Buddhist, Hindu, and Jain faiths.',
                'short_description': 'Ancient rock-cut caves showcasing Buddhist, Hindu, and Jain art',
                'latitude': Decimal('20.0254'),
                'longitude': Decimal('76.1760'),
                'best_time_to_visit': 'October to March',
                'entry_fee': '₹40 for Indians, ₹600 for foreigners',
                'opening_hours': '9:00 AM to 5:30 PM (Closed on Mondays)',
                'historical_significance': 'Built between 2nd century BC to 6th century AD, UNESCO World Heritage Sites.',
                'cultural_importance': 'Masterpieces of Buddhist religious art, influence on Indian art.',
                'local_cuisine': 'Maharashtrian Thali, Puran Poli, Vada Pav',
                'featured': True,
                'average_rating': Decimal('4.8'),
                'total_reviews': 8234,
            },
            {
                ...
                'description': 'Ooty, also known as Udagamandalam, is a popular hill station in the Nilgiri Hills known for its tea gardens, eucalyptus trees, and pleasant climate.',
                'short_description': 'Queen of Hill Stations with beautiful gardens and toy train',
                'latitude': Decimal('11.4064'),
                'longitude': Decimal('76.6932'),
                'best_time_to_visit': 'October to June',
                'entry_fee': 'Botanical Garden: ₹30, Toy Train: ₹205-370',
                'opening_hours': 'Most attractions: 9:00 AM to 6:00 PM',
                'historical_significance': 'British summer headquarters in South India, established in 1823.',
                'cultural_importance': 'Queen of Hill Stations, important for tea cultivation.',
                'local_cuisine': 'South Indian meals, Chocolate, Fresh strawberries, Tea',
                'featured': False,
                'average_rating': Decimal('4.5'),
                'total_reviews': 7456,
            },
            {
                ...
                'city': 'Port Blair',
                'categories': ['beach', 'adventure', 'eco'],
                'description': 'The Andaman Islands are a group of Indian Ocean archipelagic islands known for their pristine beaches, crystal-clear waters, and diverse marine life.',
                'short_description': 'Tropical paradise with pristine beaches and marine biodiversity',
                'latitude': Decimal('11.7401'),
                'longitude': Decimal('92.6586'),
                'best_time_to_visit': 'November to April',
                'entry_fee': 'Various activity charges apply',
                'opening_hours': 'Beach activities: Sunrise to sunset',
                'historical_significance': 'Cellular Jail - symbol of India\'s freedom struggle.',
                'cultural_importance': 'Home to indigenous tribes, important for marine conservation.',
                'local_cuisine': 'Seafood, Coconut-based curries, Fish curry rice',
                'featured': True,
